...
| **Day 2** | $\color{lightgreen}{\texttt{0.257}}$ | $\color{lightgreen}{\texttt{0.864}}$ |         |         |         |         |         | $\color{lightgreen}{\texttt{0.479}}$ | $\color{lightgreen}{\texttt{0.106}}$ |
...
| **Day 2** | $\color{lightgreen}{\texttt{0.130}}$ | $\color{lightgreen}{\texttt{0.716}}$ |         |         |         |         |         | $\color{lightgreen}{\texttt{0.613}}$ | $\color{lightgreen}{\texttt{0.103}}$ |
...
| **Day 25** | $\color{#FFFF66}{\texttt{* × 50}}$ | $\color{#9999CC}{\texttt{* × 4}}$ |         |         |         |         |         | $\color{#FFFF66}{\texttt{* × 50}}$ | $\color{#FFFF66}{\texttt{* × 50}}$ |
