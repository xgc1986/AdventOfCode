...
| **Day 10** | $\color{darkorange}{\texttt{55.183}}$ |         |         |         |         |         |         |         | $\color{orange}{\texttt{1.766}}$ |
...
| **Day 25** | $\color{#9999CC}{\texttt{* × 20}}$ | $\color{#9999CC}{\texttt{* × 2}}$ |         |         |         |         |         | $\color{#9999CC}{\texttt{* × 2}}$ | $\color{#FFFF66}{\texttt{* × 50}}$ | $\color{#9999CC}{\texttt{* × 49}}$ |
