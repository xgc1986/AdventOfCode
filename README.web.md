...
|---------|---------:|---------:|---------:|---------:|---------:|---------:|---------:|---------:|---------:|
| **Day 1** | $\color{lightgreen}{\texttt{0.245}}$ | $\color{lightgreen}{\texttt{0.121}}$ |         |         |         |         |         | $\color{lightgreen}{\texttt{0.169}}$ | $\color{lightgreen}{\texttt{0.640}}$ |
...
| **Day 11** | $\color{darkred}{\texttt{\href{https://adventofcode.com/2022/day/10}{INF}}}$ |         |         |         |         |         |         |         | $\color{orange}{\texttt{7.652}}$ |
...
| **Day 24** | $\color{darkred}{\texttt{\href{https://adventofcode.com/2022/day/10}{INF}}}$ |         |         |         |         |         |         |         | $\color{darkorange}{\texttt{35.310}}$ |
| **Day 25** | $\color{red}{\texttt{738.586}}$ |         |         |         |         |         |         |         | $\color{darkred}{\texttt{\href{https://adventofcode.com/2022/day/10}{INF}}}$ |
...
| **Day** | **2015** | **2016** | **2017** | **2018** | **2019** | **2020** | **2021** | **2022** | **2023** |
|---------|---------:|---------:|---------:|---------:|---------:|---------:|---------:|---------:|---------:|
| **Day 1** | $\color{lightgreen}{\texttt{0.108}}$ | $\color{lightgreen}{\texttt{0.273}}$ |         |         |         |         |         | $\color{lightgreen}{\texttt{0.117}}$ | $\color{orange}{\texttt{1.598}}$ |
...
| **Day 11** | $\color{darkred}{\texttt{\href{https://adventofcode.com/2022/day/10}{INF}}}$ |         |         |         |         |         |         |         | $\color{orange}{\texttt{5.165}}$ |
...
| **Day 24** | $\color{darkred}{\texttt{\href{https://adventofcode.com/2022/day/10}{INF}}}$ |         |         |         |         |         |         |         | $\color{darkred}{\texttt{>6s}}$ |
