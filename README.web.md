...
| **Day 10** | $\color{darkorange}{\texttt{61.356}}$ |         |         |         |         |         |         | $\color{lightgreen}{\texttt{0.093}}$ | $\color{orange}{\texttt{1.763}}$ |
...
| **Day 10** | $\color{darkred}{\texttt{>1s}}$ |         |         |         |         |         |         | $\color{lightgreen}{\texttt{0.194}}$ | $\color{orange}{\texttt{6.533}}$ |
