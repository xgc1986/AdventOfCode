...
| **Day 23** | $\color{lightgreen}{\texttt{0.154}}$ |         |         |         |         |         |         | $\color{darkorange}{\texttt{35.990}}$ | $\color{orange}{\texttt{1.384}}$ |
...
| **Day 25** | $\color{#FFFF66}{\texttt{* × 50}}$ | $\color{#9999CC}{\texttt{* × 2}}$ |         |         |         |         |         | $\color{#9999CC}{\texttt{* × 46}}$ | $\color{#FFFF66}{\texttt{* × 50}}$ |
