...
|---------|---------:|---------:|---------:|---------:|---------:|---------:|---------:|---------:|---------:|
| **Day 1** |         | $\color{lightgreen}{\texttt{\textit{0.125}}}$ |         |         |         |         |         |         | $\color{lightgreen}{\texttt{\textit{0.640}}}$ |
| **Day 2** |         |         |         |         |         |         |         |         | $\color{lightgreen}{\texttt{\textit{0.106}}}$ |
| **Day 3** |         |         |         |         |         |         |         |         | $\color{orange}{\texttt{2.676}}$ |
| **Day 4** |         |         |         |         |         |         |         |         | $\color{lightgreen}{\texttt{\textit{0.426}}}$ |
| **Day 5** |         |         |         |         |         |         |         |         | $\color{lightgreen}{\texttt{\textit{0.364}}}$ |
| **Day 6** |         |         |         |         |         |         |         |         | $\color{lightgreen}{\texttt{\textit{0.047}}}$ |
...
| **Day 15** |         |         |         |         |         |         |         |         | $\color{lightgreen}{\texttt{\textit{0.928}}}$ |
| **Day 16** |         |         |         |         |         |         |         |         | $\color{orange}{\texttt{6.506}}$ |
| **Day 17** |         |         |         |         |         |         |         |         | $\color{red}{\texttt{731.511}}$ |
| **Day 18** |         |         |         |         |         |         |         |         | $\color{lightgreen}{\texttt{\textit{0.195}}}$ |
